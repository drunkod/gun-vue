const __resolved__virtual_storySource_srcAccountAccounthomeStoryVue = `<script setup>
...
export {
  __resolved__virtual_storySource_srcAccountAccounthomeStoryVue as default
};
