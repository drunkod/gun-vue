import { createElementBlock$1 as createElementBlock, toDisplayString$1 as toDisplayString, createCommentVNode$1 as createCommentVNode, createVNode$1 as createVNode, withCtx$1 as withCtx, Transition$1 as Transition, Fragment$1 as Fragment, openBlock$1 as openBlock, createBaseVNode$1 as createBaseVNode, createBlock$1 as createBlock, withDirectives$1 as withDirectives, vModelText$1 as vModelText, withKeys$1 as withKeys, renderList$1 as renderList, ref$1 as ref, useMediaQuery$1 as useMediaQuery, onClickOutside$1 as onClickOutside, computed$1 as computed, watch$1 as watch, nextTick$1 as nextTick } from "./vendor.es.js";
...
const _hoisted_1 = {
  key: 0,
  class: "px-1 py-2 flex flex-col bg-dark-50 bg-opacity-95 gap-2 min-h-full overflow-y-scroll scroll-smooth absolute sm_static z-20 w-220px max-w-full max-h-full text-light-900 backdrop-filter backdrop-blur-xl",
...
const ChatTopics = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatTopics.vue"]]);
export {
  ChatTopics as default
};
