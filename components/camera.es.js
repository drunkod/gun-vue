...
const __unplugin_components_0 = { name: "la-image", render: render$2 };
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_la_image = __unplugin_components_0;
...
const FormPicture_vue_vue_type_style_index_0_scoped_114751c1_lang = "";
const _sfc_main = {
  __name: "FormPicture",
  props: {
...
const __unplugin_components_1 = { name: "la-camera", render };
export {
