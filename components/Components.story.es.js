const html = `<p><img src="/components.svg" alt=""></p>
...
<span class="line"></span></code></pre></div></code></pre>
`;
const frontmatter = { "title": "Components", "icon": "la:book-open", "group": "docs" };
const relativePath = "src/docs/Components.story.md";
export {
  frontmatter,
  html,
  relativePath
