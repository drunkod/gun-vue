import { defineComponent, useCssVars, unref, computed, useRoute, ref, openBlock, createElementBlock, createVNode, withCtx, createBaseVNode, Icon, normalizeClass, toDisplayString, createCommentVNode, defineStore, useStorage, watch, resolveComponent, withKeys, Fragment, renderList, createBlock, useEventListener, isRef, resolveDirective, withDirectives, createTextVNode, pushScopeId, popScopeId, defineAsyncComponent, vShow, __vitePreload, reactive, normalizeStyle, Transition, useTitle, onMounted, createApp, createPinia, plugin } from "../vendor.es.js";
import { isDark, histoireConfig, customLogos, toggleDark, files, mapFile, tree, _sfc_main as _sfc_main$c } from "../GenericMountStory.vue_vue_type_script_setup_true_lang.es.js";
import { useScrollOnActive, BaseListItemLink, _export_sfc, _sfc_main as _sfc_main$b, isMobile, BaseSplitPane } from "../MobileOverlay.vue_vue_type_script_setup_true_lang.es.js";
...
const StoryListItem = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-d1a05247"]]);
...
const StoryListFolder = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-41fb5f7e"]]);
const _hoisted_1$8 = {
  "data-test-id": "story-group",
  class: "htw-my-2 first:htw-mt-0 last:htw-mb-0"
};
const _hoisted_2$4 = ["onKeyup"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        __props.group.title ? (openBlock(), createElementBlock("div", {
          ...
          _hoisted_4$1
        ], 40, _hoisted_2$4)) : createCommentVNode("", true),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import("../SearchPane.es.js"), true ? ["SearchPane.es.js","vendor.es.js","story.es.js","GenericMountStory.vue_vue_type_script_setup_true_lang.es.js","BaseEmpty.es.js","MobileOverlay.vue_vue_type_script_setup_true_lang.es.js"] : void 0),
