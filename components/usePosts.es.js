import { reactive$1 as reactive, computed$1 as computed, ref$1 as ref, JSZip } from "./vendor.es.js";
import { useGun, currentRoom } from "./useDraw.es.js";
...
function usePosts(tag) {
  ...
  gun.user(currentRoom.pub).get("posts").map().on(function(data, key) {
