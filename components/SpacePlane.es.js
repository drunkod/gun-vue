...
import __unplugin_components_3$2 from "./AccountHome.es.js";
import { _export_sfc } from "./_plugin-vue_export-helper.es.js";
import "./useMates.es.js";
import "./times.es.js";
import "./useProjects.es.js";
...
const __unplugin_components_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", render$e], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/space/SpaceGuest.vue"]]);
const _hoisted_1$d = {
  class: "arrow",
  ref: "handle"
};
...
const SpaceArrow_vue_vue_type_style_index_0_scoped_c6122d00_lang = "";
const _sfc_main$2 = {
  __name: "SpaceArrow",
  props: {
    link: Object,
...
const __unplugin_components_1 = { name: "carbon-pen", render: render$2 };
const _withScopeId = (n) => (pushScopeId("data-v-3c047d3a"), n = n(), popScopeId(), n);
const _hoisted_1$1 = { class: "z-10 absolute top-4 left-4 right-4" };
...
const SpaceDraw_vue_vue_type_style_index_0_scoped_3c047d3a_lang = "";
const _sfc_main$1 = {
  __name: "SpaceDraw",
  setup(__props, { expose }) {
    expose();
...
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", render$1], ["__scopeId", "data-v-3c047d3a"], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/space/SpaceDraw.vue"]]);
...
const _hoisted_7 = ["x", "y", "viewBox"];
const _hoisted_8 = ["x", "y", "width", "height"];
const _hoisted_9 = { class: "link" };
const _hoisted_10 = ["x1", "x2", "y1", "y2", "stroke"];
const _hoisted_11 = ["transform"];
const _hoisted_12 = { class: "mouse" };
const _hoisted_13 = ["fill"];
const _hoisted_14 = { class: "arrows" };
const _hoisted_15 = { class: "guests" };
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_account_home = __unplugin_components_3$2;
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    }, "Click anywhere to join the space", 4)) : createCommentVNode("v-if", true),
    createVNode(_component_space_draw, { class: "z-500" }),
    (openBlock(), createElementBlock("svg", {
      class: "h-full w-full z-200 bg-dark-100 bg-opacity-5 cursor-pointer touch-none",
      ref: "plane",
      ...
      version: "1.1",
      baseProfile: "full",
      viewBox: `${-$props.pad + $setup.pos[0] - $setup.width / 2} ${-$props.pad + $setup.pos[1] - $setup.height / 2} ${$setup.width * $setup.zoom + 2 * $props.pad} ${$setup.height * $setup.zoom + 2 * $props.pad}`,
      ...
      (openBlock(), createElementBlock("svg", {
        class: normalizeClass(["opacity-70", { "pointer-events-none": !$setup.draw.enabled, "touch-none": $setup.draw.enabled }]),
        x: $setup.pos[0] - $setup.width / 2 - $props.pad,
        y: $setup.pos[1] - $setup.height / 2 - $props.pad,
    ...
    createVNode(_component_ui_layer, {
      ...
      onClose: _cache[7] || (_cache[7] = ($event) => $setup.selectedUser.pub = null)
    }, {
      default: withCtx(() => [
        (openBlock(), createBlock(_component_account_home, {
          class: "max-w-600px",
          pub: $setup.selectedUser.pub,
          onUser: _cache[3] || (_cache[3] = ($event) => _ctx.$emit("user", $event)),
          onPost: _cache[4] || (_cache[4] = ($event) => _ctx.$emit("post", _ctx.safeHash($event))),
          onChat: _cache[5] || (_cache[5] = ($event) => _ctx.$emit("chat", $setup.selectedUser.pub)),
          onClose: _cache[6] || (_cache[6] = ($event) => $setup.selectedUser.pub = null),
...
const _sfc_main = {
  ...
  emits: ["user", "enter", "leave", "chat", "update:coord"],
  setup(__props, { expose, emit }) {
    expose();
    const props = __props;
    const { user } = useUser();
    ...
    const debouncedCoord = useDebounceFn((pos2) => {
      place({ x: pos2[0], y: pos2[1] });
      emit("update:coord", `${pos2[0]},${pos2[1]}`);
    }, 200);
    useDrag((e) => {
...
const SpacePlane = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/space/SpacePlane.vue"]]);
export {
  SpacePlane as default
};
