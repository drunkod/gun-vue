...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    expose();
    const QrLoad = defineAsyncComponent(() => __vitePreload(() => import("./QrLoad.es.js"), true ? ["QrLoad.es.js","vendor.es.js","_plugin-vue_export-helper.es.js"] : void 0));
...
const QrLoad_story = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/qr/QrLoad.story.vue"]]);
export {
  QrLoad_story as default
};
