...
import { useUser, currentRoom, useAccount, useDictRecordsBy, useDictLangs, dictLang, useDictAuthors, useGun, useColor, useDictRecordsFor, dictRecord, selectedUser, useWord, letterFilter, useDefs, useWords, user, gun, useProject } from "./useDraw.es.js";
...
import { languages, langParts, usePosts } from "./usePosts.es.js";
...
const __unplugin_components_0 = { name: "la-comment-dots", render: render$4 };
const _hoisted_1$2 = {
  key: 0,
  class: "flex gap-2"
};
...
const __unplugin_components_2 = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", render$3], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatInput.vue"]]);
...
const __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", render$2], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatMessages.vue"]]);
const _hoisted_1$1 = {
...
const _hoisted_4$1 = { class: "p-4 bg-dark-50 bg-opacity-80 flex gap-2 flex sticky bottom-0" };
...
const ChatRoom = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", render$1], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatRoom.vue"]]);
const ChatRoom$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ChatRoom
...
const DictLinkButton_vue_vue_type_style_index_0_scoped_0900ff00_lang = "";
const _sfc_main$q = {
...
const DictDefCard_vue_vue_type_style_index_0_scoped_4e7c31d0_lang = "";
const _sfc_main$o = {
  __name: "DictDefCard",
  props: {
    hash: String,
...
const DictWordCard_vue_vue_type_style_index_0_scoped_175bd9f7_lang = "";
const _sfc_main$n = {
  __name: "DictWordCard",
  props: {
    hash: String
...
const DictDefPage_vue_vue_type_style_index_0_scoped_29424599_lang = "";
const _sfc_main$l = {
  __name: "DictDefPage",
  props: {
    hash: String
...
const DictWordPage_vue_vue_type_style_index_0_scoped_3a954dd5_lang = "";
const _sfc_main$j = {
  __name: "DictWordPage",
  props: {
    hash: String
...
const EmbedYoutube_vue_vue_type_style_index_0_scoped_fde438a5_lang = "";
const _sfc_main$i = {
  __name: "EmbedYoutube",
  props: ["video"],
  setup(__props, { expose }) {
...
const FormLink_vue_vue_type_style_index_0_scoped_4f0c7fe8_lang = "";
const _sfc_main$h = {
  __name: "FormLink",
  emits: ["update"],
  setup(__props, { expose, emit }) {
...
const FormYoutube_vue_vue_type_style_index_0_scoped_96ff44cd_lang = "";
const _sfc_main$g = {
  __name: "FormYoutube",
  props: {
    id: { type: String }
...
const PostForm_vue_vue_type_style_index_0_scoped_6e013c55_lang = "";
const _sfc_main$e = {
  __name: "PostForm",
  props: {
  ...
  setup(__props, { expose, emit }) {
    ...
    const props = __props;
    useCssVars((_ctx) => ({
      "6e013c55-addColor": unref(addColor)
    }));
    const colorDeep = useColor("deep");
...
const PostLine_vue_vue_type_style_index_0_scoped_b5f2ef9c_lang = "";
const _sfc_main$c = {
  __name: "PostLine",
  props: {
...
const PostActionUpdate_vue_vue_type_style_index_0_scoped_e7a2d80a_lang = "";
const _sfc_main$9 = {
...
_sfc_main$5.__file = "src/project/ProjectFunding.vue";
const _sfc_main$4 = {
  __name: "ProjectPage",
  props: {
    path: { type: String, default: "" }
...
_sfc_main$4.__file = "src/project/ProjectPage.vue";
const _sfc_main$3 = {};
_sfc_main$3.__file = "src/room/RoomProfile.vue";
const _sfc_main$2 = {
  __name: "UiModal",
  props: {
    open: { default: false }
...
_sfc_main$2.__file = "src/ui/UiModal.vue";
const _sfc_main$1 = {
  __name: "UtilTools",
  setup(__props, { expose }) {
    expose();
...
_sfc_main$1.__file = "src/util/UtilTools.vue";
resolveComponent();
const _hoisted_1 = ["id", "data-pub"];
const _hoisted_2 = { class: "ml-2 text-sm opacity-20 hover_opacity-80 transition cursor-default text-light-200" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", { class: "flex-1" }, null, -1);
const _hoisted_4 = { class: "ml-2 text-sm opacity-20 hover_opacity-80 transition cursor-default text-dark-200" };
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _a, _b;
  const _component_account_badge = __unplugin_components_0$1;
  return openBlock(), createElementBlock("div", {
    class: "px-1 py-2px flex flex-col w-full gap-1",
    ...
    withDirectives(createBaseVNode("div", {
      ...
      createBaseVNode("div", _hoisted_2, toDisplayString((_a = $setup.dateTime) == null ? void 0 : _a.time), 1),
      _hoisted_3,
      createBaseVNode("div", _hoisted_4, toDisplayString((_b = $setup.dateTime) == null ? void 0 : _b.date), 1)
    ], 12, _hoisted_1), [
      [vShow, $setup.fresh]
    ]),
    createBaseVNode("div", {
      class: "px-2 py-1 bg-light-300 bg-opacity-80 rounded-b-xl max-w-max break-all overflow-hidden",
      style: normalizeStyle({ borderTopLeftRadius: $setup.isMe ? "12px" : "0px", borderTopRightRadius: $setup.isMe ? "0px" : "12px", fontSize: $props.source.text == $setup.getFirstEmoji($props.source.text) ? "6em" : "1em" })
    }, [
...
const _sfc_main = {
  ...
  setup(__props, { expose }) {
    ...
    onMounted(() => {
      var _a, _b;
      if (props.index > 1) {
        const prevPub = (_b = (_a = document.getElementById(`chat-${props.index - 1}`)) == null ? void 0 : _a.dataset) == null ? void 0 : _b.pub;
...
const ChatMessage = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", render], ["__file", "/Users/davay/Documents/\u0424\u0420\u0423\u041A\u0422/DeFUCC/gun-vue/components/src/chat/ChatMessage.vue"]]);
const ChatMessage$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ChatMessage
}, Symbol.toStringTag, { value: "Module" }));
export {
  ChatMessage$1 as ChatMessage,
  ChatRoom$1 as ChatRoom
};
